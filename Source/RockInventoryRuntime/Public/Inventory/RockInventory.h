...
public:
	...
	void ForEachSlot(const TFunctionRef<bool(const FRockInventorySlotEntry&)>& Func) const;
	...
	void SetItemCustomValue1(const FRockItemStackHandle& Handle, int32 newCount);
	void SetItemCustomValue2(const FRockItemStackHandle& Handle, int32 newCount);
