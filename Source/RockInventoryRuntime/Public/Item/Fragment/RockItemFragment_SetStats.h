...
struct ROCKINVENTORYRUNTIME_API FRockItemFragment_SetStats : public FRockItemFragment
{
	...
	// Only happens once at initialization. Should be super infrequently queried. Back of the array for you!
	virtual int32 GetSortOrder() const override { return 1000000; }
};
